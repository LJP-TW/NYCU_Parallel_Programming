...
test_pi(2, 'pi_gather')
test_pi(2, '/HW4/ref/pi_gather')
test_pi(4, 'pi_gather')
test_pi(4, '/HW4/ref/pi_gather')
test_pi(8, 'pi_gather')
test_pi(8, '/HW4/ref/pi_gather')
test_pi(12, 'pi_gather')
test_pi(12, '/HW4/ref/pi_gather')
test_pi(16, 'pi_gather')
test_pi(16, '/HW4/ref/pi_gather')

test_pi(2, 'pi_reduce')
test_pi(2, '/HW4/ref/pi_reduce')
test_pi(4, 'pi_reduce')
test_pi(4, '/HW4/ref/pi_reduce')
test_pi(8, 'pi_reduce')
test_pi(8, '/HW4/ref/pi_reduce')
test_pi(12, 'pi_reduce')
test_pi(12, '/HW4/ref/pi_reduce')
test_pi(16, 'pi_reduce')
test_pi(16, '/HW4/ref/pi_reduce')
